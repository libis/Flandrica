<?php
/**
* @package AtomExtend plugin
* @subpackage Models
* @copyright Libis
*/

/**
* Model class for an customised Atom feed, used in various Libis projects (extends existing functionality)).
*
* @link http://en.wikipedia.org/wiki/Atom_(standard)
*/
class AtomExtend extends ItemAtom
{
    /**
* @var DOMDocument
*/
