...
/* Added by Sam. The mod_rewrite in the root .htaccess (dynamic virtual host) causes a problem in the routing of Okeme/Zend. Therefore, the baseurl has to be overridden based on the configuration that are set in paths.php (CURRENT_BASE_URL) */
$app->getBootstrap()->getResource('FrontController')->setBaseUrl(CURRENT_BASE_URL);
/* End addings of Sam */
