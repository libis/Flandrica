    ...
    <footer>
        ...
        <div class="madeby">&copy; <a href="http://www.vlaamse-erfgoedbibliotheek.be"><?php echo __('Vlaamse Erfgoedbibliotheek');?></a></div>
        	<div class="sponsors">
        		<div style="float:right;"><a href="<?php echo uri($lang.'gebruiksvoorwaarden/'); ?>"><img src="<?php echo img("logobalk-cc.png");?>" title="CC BY-NC-SA 2.0" alt="Logo CreativeCommons CC BY-NC-SA 2.0" /></a><br><a href="http://www.vlaanderen.be"><img style="padding-left:14px;" src="<?php echo img("footer_03.jpg");?>" title="Met steun van de Vlaamse overheid" alt="<?php echo __("Logo Met steun van de Vlaamse overheid");?> /></a>
        		</div>
        		<a href="http://www.vlaamse-erfgoedbibliotheek.be/"><img src="<?php echo img("logobalk-veb.png");?>" title="Een initiatief van de Vlaamse Erfgoedbibliotheek" alt="<?php echo __('Logo van de Vlaamse Erfgoedbibliotheek');?>"></a>
    			<a href="<?php echo uri($lang.'partners/'); ?>"><img src="<?php echo img("logobalk-partners.png");?>" title="De partners van Flandrica.be" alt="<?php echo __("Logo's van de partners van Flandrica.be");?>"/></a>
    		</div>
        </div>
        <?php echo ga_footer();?>
    </footer>
