    ...
    <footer>
        ...
        <div class="madeby">&copy; <a href="http://www.vlaamse-erfgoedbibliotheek.be">Vlaamse Erfgoedbibliotheek</a></div>
        	<div class="sponsors">
    			...
    			<a href="<?php echo uri($lang.'partners/'); ?>"><img src="<?php echo img("logobalk-partners.png");?>" title="De partners van Flandrica.be" alt="Logo's van de partners van Flandrica.be"/></a>
    		</div>
        </div>
        <?php echo ga_footer();?>
    </footer>
